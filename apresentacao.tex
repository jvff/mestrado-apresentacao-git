...
\begin{slide}
    \begin{itemize}
        ...
        \begin{itemize}
            \pause
            \item \texttt{git clone "url"} Cria um repositório local, copiando
                o repositório remoto do endereço especificado
            \pause
            \item \texttt{git remote add "nome"}\texttt{ "url"} Acrescenta o
                registro de um repositório remoto
            \pause
            \item \texttt{git remote rm "nome"} Remove o registro de um
                repositório remoto
            \pause
            \item \texttt{git push "repositorio"}\texttt{ "ponteiro"} Envia
                o ponteiro e os \emph{commits} necessários para o repositório
                remoto
            \pause
            \item \texttt{git fetch "repositorio"} Atualiza os ponteiros locais
                com o estado dos ponteiros remotos
        \end{itemize}
    \end{itemize}
\end{slide}
